...
# Run polarization model job array using config files in configs/ directory.  A separate job is
# created for each configuration file.  This is the main script for submitting multiple
# polarization simulations in parallel.
#
